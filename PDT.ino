...
#define pinoTouchLess 12  //menos-
#define pinoTouchMore 14  //mais+
...
double leitura_lux = 0; //leitura do sensor em lux
...
void TarefaLeAjustes( void * parameter)
{
  ...
  { 
    ...
    if(ajusteBlue<0)ajusteBlue=0;if(ajusteBlue>255)ajusteBlue=255;
      ...
      if(touchRead(pinoTouchStart) < 20)
      {
        delay(300);
...
void TarefaLeLux( void * parameter)
{
  while(1)
  {
    ...
    leitura_joule = leitura_lux/10000; //agora temos lúmens/cm^2
